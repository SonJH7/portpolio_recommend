...
# False 하면 좁게 , True 하면 넓게 됨
# 정렬, 간격 수정 등 가능 (dynamic)
...
# # 메트릭
st.metric(label="온도", value="10°C", delta="1.2°C") #양수면 파란색
st.metric(label="삼성전자", value="61,000 원", delta="-1,200 원") #음수면 빨간색
